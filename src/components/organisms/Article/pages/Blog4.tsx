...
const Blog4 = () => {
  ...
  return (
    <main className="min-h-[100vh]">
      <SEO
        description={articleList[3].metaDescription}
        keywords={articleList[3].metaKeyword}
        title={articleList[3].metaTitle}
      />
      <section className="h-[40vh] w-full">
        ...
        <div className="absolute z-10 top-[180px] left-10 text-white text-3xl">
          ...
          <h6 className="text-3xl">{articleList[3]?.metaTitle}</h6>
        </div>
      </section>
      ...
      <section className="flex flex-col md:flex-row items-start ">
        <section className="md:w-[70%] w-[100%] p-10">
          ...
          <div className="py-3">
            <Image
              src={articleList[3]?.filePath}
              alt={articleList[3]?.articleHeading}
