...
const Blog2 = () => {
  ...
  return (
    <main className="min-h-[100vh]">
      <SEO
        description={articleList[1].metaDescription}
        keywords={articleList[1].metaKeyword}
        title={articleList[1].metaTitle}
      />
      <section className="h-[40vh] w-full">
        ...
        <div className="absolute z-10 top-[180px] left-10 text-white text-3xl">
          ...
          <h6 className="text-3xl">{articleList[1]?.metaTitle}</h6>
        </div>
      </section>
      ...
      <section className="flex flex-col md:flex-row items-start ">
        <section className="md:w-[70%] w-[100%] p-10">
          <div className="space-y-5">
            <h1 className="text-xl font-semibold">{articleList[1]?.articleHeading}</h1>
            <span className="text-red text-[13px]">{articleList[1]?.articleDate}</span>
          </div>
          <div className="py-3">
            <Image
              src={articleList[1]?.filePath}
              alt={articleList[1]?.articleHeading}
